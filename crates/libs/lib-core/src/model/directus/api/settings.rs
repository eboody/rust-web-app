...
pub struct Settings {
	...
	#[serde(
		rename = "public_background",
		default,
		with = "::serde_with::rust::double_option",
		skip_serializing_if = "Option::is_none"
	)]
	pub public_background: Option<Option<Box<super::SettingsPublicBackground>>>,
	...
	#[serde(
		rename = "auth_login_attempts",
		skip_serializing_if = "Option::is_none"
	)]
	pub auth_login_attempts: Option<i32>,
	/// Authentication password policy.
	#[serde(
		rename = "auth_password_policy",
		default,
		with = "::serde_with::rust::double_option",
		skip_serializing_if = "Option::is_none"
	)]
	...
	#[serde(
		rename = "storage_asset_transform",
		default,
		with = "::serde_with::rust::double_option",
		skip_serializing_if = "Option::is_none"
	)]
	...
	/// Array of allowed
	#[serde(
		rename = "storage_asset_presets",
		default,
		with = "::serde_with::rust::double_option",
		skip_serializing_if = "Option::is_none"
	)]
	pub storage_asset_presets:
		Option<Option<Vec<super::SettingsStorageAssetPresetsInner>>>,
	#[serde(
		rename = "custom_css",
		default,
		with = "::serde_with::rust::double_option",
	...
	pub public_favicon: Option<Option<Box<super::SettingsPublicFavicon>>>,
	#[serde(rename = "default_appearance", skip_serializing_if = "Option::is_none")]
	pub default_appearance: Option<String>,
	#[serde(
		rename = "default_theme_light",
		default,
		with = "::serde_with::rust::double_option",
		skip_serializing_if = "Option::is_none"
	)]
	...
	#[serde(
		rename = "public_registration",
		skip_serializing_if = "Option::is_none"
	)]
	pub public_registration: Option<bool>,
	/// $t:fields.directus_settings.public_registration_verify_email_note
	#[serde(
		rename = "public_registration_verify_email",
		skip_serializing_if = "Option::is_none"
	)]
	pub public_registration_verify_email: Option<bool>,
	#[serde(
		rename = "public_registration_role",
		default,
		with = "::serde_with::rust::double_option",
		skip_serializing_if = "Option::is_none"
	)]
	pub public_registration_role:
		Option<Option<Box<super::SettingsPublicRegistrationRole>>>,
	/// $t:fields.directus_settings.public_registration_email_filter_note
	#[serde(
		rename = "public_registration_email_filter",
		default,
		with = "::serde_with::rust::double_option",
		skip_serializing_if = "Option::is_none"
	)]
