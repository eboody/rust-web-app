...
pub struct Versions {
	...
	pub collection: Option<Box<super::VersionsCollection>>,
	...
	pub user_created: Option<Box<super::VersionsUserCreated>>,
	#[serde(rename = "user_updated", skip_serializing_if = "Option::is_none")]
	pub user_updated: Option<Box<super::VersionsUserUpdated>>,
