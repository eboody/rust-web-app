...
pub struct Comments {
	...
	pub collection: Option<Box<super::CommentsCollection>>,
	...
	pub user_created: Option<Box<super::CommentsUserCreated>>,
	#[serde(rename = "user_updated", skip_serializing_if = "Option::is_none")]
	pub user_updated: Option<Box<super::CommentsUserUpdated>>,
}
