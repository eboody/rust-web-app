...
pub struct Activity {
	...
	pub user: Option<Option<Box<super::ActivityUser>>>,
	/// When the action happened.
	#[serde(rename = "timestamp", skip_serializing_if = "Option::is_none")]
	pub timestamp: Option<String>,
	#[serde(rename = "ip", skip_serializing_if = "Option::is_none")]
	pub ip: Option<Box<super::ActivityIp>>,
	...
	pub collection: Option<Box<super::ActivityCollection>>,
	...
	pub revisions: Option<Option<Vec<super::ActivityRevisionsInner>>>,
}
