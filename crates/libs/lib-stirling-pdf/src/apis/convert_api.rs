...
pub trait ConvertApi: Send + Sync {
	...
	>(
		...
		image_format: Option<&'image_format str>,
		single_or_multiple: Option<&'single_or_multiple str>,
		color_type: Option<&'color_type str>,
		dpi: Option<&'dpi str>,
	) -> Result<Vec<String>, Error<ConvertToImageError>>;
	async fn convert_to_pdf<'file_input, 'fit_option, 'color_type, 'auto_rotate>(
		&self,
		file_input: Option<Vec<std::path::PathBuf>>,
		fit_option: Option<&'fit_option str>,
		color_type: Option<&'color_type str>,
		auto_rotate: Option<bool>,
	) -> Result<Vec<String>, Error<ConvertToPdfError>>;
	async fn html_to_pdf<'file_input, 'zoom>(
		&self,
		file_input: Option<std::path::PathBuf>,
		zoom: Option<f32>,
	) -> Result<Vec<String>, Error<HtmlToPdfError>>;
	async fn markdown_to_pdf<'file_input>(
		&self,
		file_input: Option<std::path::PathBuf>,
	) -> Result<Vec<String>, Error<MarkdownToPdfError>>;
	async fn pdf_to_csv<'file_input, 'page_id>(
		&self,
		file_input: Option<std::path::PathBuf>,
		page_id: Option<f64>,
	) -> Result<String, Error<PdfToCsvError>>;
	async fn pdf_to_pdf_a<'file_input, 'output_format>(
		&self,
		file_input: Option<std::path::PathBuf>,
		output_format: Option<&'output_format str>,
	) -> Result<Vec<String>, Error<PdfToPdfAError>>;
	async fn process_file_to_pdf<'file_input>(
		&self,
		file_input: Option<std::path::PathBuf>,
	) -> Result<Vec<String>, Error<ProcessFileToPdfError>>;
	async fn process_pdf_to_html<'file_input>(
		&self,
		file_input: Option<std::path::PathBuf>,
	) -> Result<Vec<String>, Error<ProcessPdfToHtmlError>>;
	async fn process_pdf_to_presentation<'file_input, 'output_format>(
		&self,
		file_input: Option<std::path::PathBuf>,
		output_format: Option<&'output_format str>,
	) -> Result<Vec<String>, Error<ProcessPdfToPresentationError>>;
	async fn process_pdf_to_rt_for_txt<'file_input, 'output_format>(
		&self,
		file_input: Option<std::path::PathBuf>,
		output_format: Option<&'output_format str>,
	) -> Result<Vec<String>, Error<ProcessPdfToRtForTxtError>>;
	async fn process_pdf_to_word<'file_input, 'output_format>(
		&self,
		file_input: Option<std::path::PathBuf>,
		output_format: Option<&'output_format str>,
	) -> Result<Vec<String>, Error<ProcessPdfToWordError>>;
	async fn process_pdf_to_xml<'file_input>(
		&self,
		file_input: Option<std::path::PathBuf>,
	) -> Result<Vec<String>, Error<ProcessPdfToXmlError>>;
	async fn url_to_pdf<'url_input>(
		&self,
		url_input: &'url_input str,
	) -> Result<Vec<String>, Error<UrlToPdfError>>;
}
...
impl ConvertApi for ConvertApiClient {
	...
	>(
		...
		if let Some(local_var_param_value) = image_format {
			local_var_form = local_var_form
				.text("imageFormat", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = single_or_multiple {
			local_var_form = local_var_form
				.text("singleOrMultiple", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = color_type {
			local_var_form =
				local_var_form.text("colorType", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = dpi {
			local_var_form =
				local_var_form.text("dpi", local_var_param_value.to_string());
		}
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<ConvertToImageError> =
	...
	async fn convert_to_pdf<'file_input, 'fit_option, 'color_type, 'auto_rotate>(
		...
		if let Some(local_var_param_value) = fit_option {
			local_var_form =
				local_var_form.text("fitOption", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = color_type {
			local_var_form =
				local_var_form.text("colorType", local_var_param_value.to_string());
		...
		if let Some(local_var_param_value) = auto_rotate {
			local_var_form =
				local_var_form.text("autoRotate", local_var_param_value.to_string());
		}
		local_var_req_builder = local_var_req_builder.multipart(local_var_form);
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<ConvertToPdfError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn html_to_pdf<'file_input, 'zoom>(
		...
		if let Some(local_var_param_value) = zoom {
			local_var_form =
				local_var_form.text("zoom", local_var_param_value.to_string());
		}
		local_var_req_builder = local_var_req_builder.multipart(local_var_form);
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<HtmlToPdfError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn markdown_to_pdf<'file_input>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<MarkdownToPdfError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn pdf_to_csv<'file_input, 'page_id>(
		...
		if let Some(local_var_param_value) = page_id {
			local_var_form =
				local_var_form.text("pageId", local_var_param_value.to_string());
		}
		local_var_req_builder = local_var_req_builder.multipart(local_var_form);
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<PdfToCsvError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn pdf_to_pdf_a<'file_input, 'output_format>(
		...
		if let Some(local_var_param_value) = output_format {
			local_var_form = local_var_form
				.text("outputFormat", local_var_param_value.to_string());
		}
		local_var_req_builder = local_var_req_builder.multipart(local_var_form);
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<PdfToPdfAError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn process_file_to_pdf<'file_input>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<ProcessFileToPdfError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn process_pdf_to_html<'file_input>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<ProcessPdfToHtmlError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn process_pdf_to_presentation<'file_input, 'output_format>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<ProcessPdfToPresentationError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn process_pdf_to_rt_for_txt<'file_input, 'output_format>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<ProcessPdfToRtForTxtError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn process_pdf_to_word<'file_input, 'output_format>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<ProcessPdfToWordError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn process_pdf_to_xml<'file_input>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<ProcessPdfToXmlError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn url_to_pdf<'url_input>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<UrlToPdfError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
