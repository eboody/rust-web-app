...
pub async fn convert_to_image(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>, image_format: Option<&str>, single_or_multiple: Option<&str>, color_type: Option<&str>, dpi: Option<&str>) -> Result<Vec<String>, Error<ConvertToImageError>> {
...
pub async fn convert_to_pdf(configuration: &configuration::Configuration, file_input: Option<Vec<std::path::PathBuf>>, fit_option: Option<&str>, color_type: Option<&str>, auto_rotate: Option<bool>) -> Result<Vec<String>, Error<ConvertToPdfError>> {
    let local_var_configuration = configuration;
...
pub async fn html_to_pdf(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>, zoom: Option<f32>) -> Result<Vec<String>, Error<HtmlToPdfError>> {
    let local_var_configuration = configuration;
...
pub async fn markdown_to_pdf(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>) -> Result<Vec<String>, Error<MarkdownToPdfError>> {
    let local_var_configuration = configuration;
...
pub async fn pdf_to_csv(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>, page_id: Option<f64>) -> Result<String, Error<PdfToCsvError>> {
    let local_var_configuration = configuration;
...
pub async fn pdf_to_pdf_a(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>, output_format: Option<&str>) -> Result<Vec<String>, Error<PdfToPdfAError>> {
    let local_var_configuration = configuration;
...
pub async fn process_file_to_pdf(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>) -> Result<Vec<String>, Error<ProcessFileToPdfError>> {
    let local_var_configuration = configuration;
...
pub async fn process_pdf_to_html(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>) -> Result<Vec<String>, Error<ProcessPdfToHtmlError>> {
    let local_var_configuration = configuration;
...
pub async fn process_pdf_to_presentation(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>, output_format: Option<&str>) -> Result<Vec<String>, Error<ProcessPdfToPresentationError>> {
    let local_var_configuration = configuration;
...
pub async fn process_pdf_to_rt_for_txt(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>, output_format: Option<&str>) -> Result<Vec<String>, Error<ProcessPdfToRtForTxtError>> {
    let local_var_configuration = configuration;
...
pub async fn process_pdf_to_word(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>, output_format: Option<&str>) -> Result<Vec<String>, Error<ProcessPdfToWordError>> {
    let local_var_configuration = configuration;
...
pub async fn process_pdf_to_xml(configuration: &configuration::Configuration, file_input: Option<std::path::PathBuf>) -> Result<Vec<String>, Error<ProcessPdfToXmlError>> {
    let local_var_configuration = configuration;
...
pub async fn url_to_pdf(configuration: &configuration::Configuration, url_input: &str) -> Result<Vec<String>, Error<UrlToPdfError>> {
    let local_var_configuration = configuration;
