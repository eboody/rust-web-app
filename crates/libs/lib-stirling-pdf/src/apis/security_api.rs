...
pub trait SecurityApi: Send + Sync {
	...
	>(
		...
		owner_password: Option<&'owner_password str>,
		password: Option<&'password str>,
		key_length: Option<i32>,
		can_assemble_document: Option<bool>,
		can_extract_content: Option<bool>,
		can_extract_for_accessibility: Option<bool>,
		can_fill_in_form: Option<bool>,
		can_modify: Option<bool>,
		can_modify_annotations: Option<bool>,
		can_print: Option<bool>,
		can_print_faithful: Option<bool>,
	) -> Result<Vec<String>, Error<AddPasswordError>>;
	...
	>(
		&self,
		watermark_type: &'watermark_type str,
		file_input: Option<std::path::PathBuf>,
		watermark_text: Option<&'watermark_text str>,
		watermark_image: Option<std::path::PathBuf>,
		alphabet: Option<&'alphabet str>,
		font_size: Option<f32>,
		rotation: Option<f32>,
		opacity: Option<f32>,
		width_spacer: Option<i32>,
		height_spacer: Option<i32>,
		convert_pdfto_image: Option<bool>,
	) -> Result<Vec<String>, Error<AddWatermarkError>>;
	async fn get_pdf_info<'file_input>(
		&self,
		file_input: Option<std::path::PathBuf>,
	) -> Result<Vec<String>, Error<GetPdfInfoError>>;
	async fn redact_pdf<
		'list_of_text,
		'file_input,
		'use_regex,
	...
	>(
		&self,
		list_of_text: &'list_of_text str,
		file_input: Option<std::path::PathBuf>,
		use_regex: Option<bool>,
		whole_word_search: Option<bool>,
		redact_color: Option<&'redact_color str>,
		custom_padding: Option<f64>,
		convert_pdfto_image: Option<bool>,
	) -> Result<Vec<String>, Error<RedactPdfError>>;
	async fn remove_cert_sign_pdf<'file_input>(
		&self,
		file_input: Option<std::path::PathBuf>,
	) -> Result<Vec<String>, Error<RemoveCertSignPdfError>>;
	async fn remove_password<'password, 'file_input>(
		&self,
		password: &'password str,
		file_input: Option<std::path::PathBuf>,
	) -> Result<Vec<String>, Error<RemovePasswordError>>;
	...
	>(
		&self,
		file_input: Option<std::path::PathBuf>,
		remove_java_script: Option<bool>,
		remove_embedded_files: Option<bool>,
		remove_metadata: Option<bool>,
		remove_links: Option<bool>,
		remove_fonts: Option<bool>,
	) -> Result<Vec<String>, Error<SanitizePdfError>>;
	async fn sign_pdf_with_cert<
		'file_input,
		'cert_type,
		'private_key_file,
		'cert_file,
	...
	>(
		&self,
		file_input: Option<std::path::PathBuf>,
		cert_type: Option<&'cert_type str>,
		...
		location: Option<&'location str>,
		name: Option<&'name str>,
		page_number: Option<i32>,
		show_logo: Option<bool>,
	) -> Result<Vec<String>, Error<SignPdfWithCertError>>;
}
...
impl SecurityApi for SecurityApiClient {
	...
	>(
		...
		if let Some(local_var_param_value) = owner_password {
			local_var_form = local_var_form
				.text("ownerPassword", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = password {
			local_var_form =
				local_var_form.text("password", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = key_length {
			local_var_form =
				local_var_form.text("keyLength", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = can_assemble_document {
			local_var_form = local_var_form
				.text("canAssembleDocument", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = can_extract_content {
			local_var_form = local_var_form
				.text("canExtractContent", local_var_param_value.to_string());
		}
		...
		if let Some(local_var_param_value) = can_fill_in_form {
			local_var_form = local_var_form
				.text("canFillInForm", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = can_modify {
			local_var_form =
				local_var_form.text("canModify", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = can_modify_annotations {
			local_var_form = local_var_form
				.text("canModifyAnnotations", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = can_print {
			local_var_form =
				local_var_form.text("canPrint", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = can_print_faithful {
			local_var_form = local_var_form
				.text("canPrintFaithful", local_var_param_value.to_string());
		}
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<AddPasswordError> =
	...
	>(
		...
		// TODO: support file upload for 'fileInput' parameter
		local_var_form =
			local_var_form.text("watermarkType", watermark_type.to_string());
		if let Some(local_var_param_value) = watermark_text {
			local_var_form = local_var_form
				.text("watermarkText", local_var_param_value.to_string());
		}
		...
		if let Some(local_var_param_value) = width_spacer {
			local_var_form = local_var_form
				.text("widthSpacer", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = height_spacer {
			local_var_form = local_var_form
				.text("heightSpacer", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = convert_pdfto_image {
			local_var_form = local_var_form
				.text("convertPDFToImage", local_var_param_value.to_string());
		}
		local_var_req_builder = local_var_req_builder.multipart(local_var_form);
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<AddWatermarkError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn get_pdf_info<'file_input>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<GetPdfInfoError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	>(
		...
		if let Some(local_var_param_value) = use_regex {
			local_var_form =
				local_var_form.text("useRegex", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = whole_word_search {
			local_var_form = local_var_form
				.text("wholeWordSearch", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = redact_color {
			local_var_form = local_var_form
				.text("redactColor", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = custom_padding {
			local_var_form = local_var_form
				.text("customPadding", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = convert_pdfto_image {
			local_var_form = local_var_form
				.text("convertPDFToImage", local_var_param_value.to_string());
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<RedactPdfError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn remove_cert_sign_pdf<'file_input>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<RemoveCertSignPdfError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	>(
		...
		if let Some(local_var_param_value) = remove_java_script {
			local_var_form = local_var_form
				.text("removeJavaScript", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = remove_embedded_files {
			local_var_form = local_var_form
				.text("removeEmbeddedFiles", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = remove_metadata {
			local_var_form = local_var_form
				.text("removeMetadata", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = remove_links {
			local_var_form = local_var_form
				.text("removeLinks", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = remove_fonts {
			local_var_form = local_var_form
				.text("removeFonts", local_var_param_value.to_string());
		}
		local_var_req_builder = local_var_req_builder.multipart(local_var_form);
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<SanitizePdfError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	>(
		...
		if let Some(local_var_param_value) = cert_type {
			local_var_form =
				local_var_form.text("certType", local_var_param_value.to_string());
		}
		...
		if let Some(local_var_param_value) = show_signature {
			local_var_form = local_var_form
				.text("showSignature", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = reason {
			local_var_form =
				local_var_form.text("reason", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = location {
			local_var_form =
				local_var_form.text("location", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = name {
			local_var_form =
				local_var_form.text("name", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = page_number {
			local_var_form =
				local_var_form.text("pageNumber", local_var_param_value.to_string());
		}
		if let Some(local_var_param_value) = show_logo {
			local_var_form =
				local_var_form.text("showLogo", local_var_param_value.to_string());
		}
		local_var_req_builder = local_var_req_builder.multipart(local_var_form);
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<SignPdfWithCertError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
