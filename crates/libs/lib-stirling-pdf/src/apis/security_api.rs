...
pub async fn add_password(
	...
	if let Some(local_var_param_value) = owner_password {
		local_var_form =
			local_var_form.text("ownerPassword", local_var_param_value.to_string());
	}
	...
	if let Some(local_var_param_value) = can_fill_in_form {
		local_var_form =
			local_var_form.text("canFillInForm", local_var_param_value.to_string());
	}
...
pub async fn add_watermark(
	...
	if let Some(local_var_param_value) = watermark_text {
		local_var_form =
			local_var_form.text("watermarkText", local_var_param_value.to_string());
	}
	...
	if let Some(local_var_param_value) = width_spacer {
		local_var_form =
			local_var_form.text("widthSpacer", local_var_param_value.to_string());
	}
	if let Some(local_var_param_value) = height_spacer {
		local_var_form =
			local_var_form.text("heightSpacer", local_var_param_value.to_string());
	}
...
pub async fn redact_pdf(
	...
	if let Some(local_var_param_value) = redact_color {
		local_var_form =
			local_var_form.text("redactColor", local_var_param_value.to_string());
	}
	if let Some(local_var_param_value) = custom_padding {
		local_var_form =
			local_var_form.text("customPadding", local_var_param_value.to_string());
	}
	if let Some(local_var_param_value) = convert_pdfto_image {
		local_var_form = local_var_form
			.text("convertPDFToImage", local_var_param_value.to_string());
...
pub async fn remove_cert_sign_pdf(
	configuration: &configuration::Configuration,
	file_input: Option<std::path::PathBuf>,
...
pub async fn sanitize_pdf(
	...
	if let Some(local_var_param_value) = remove_metadata {
		local_var_form =
			local_var_form.text("removeMetadata", local_var_param_value.to_string());
	}
	if let Some(local_var_param_value) = remove_links {
		local_var_form =
			local_var_form.text("removeLinks", local_var_param_value.to_string());
	}
	if let Some(local_var_param_value) = remove_fonts {
		local_var_form =
			local_var_form.text("removeFonts", local_var_param_value.to_string());
	}
	local_var_req_builder = local_var_req_builder.multipart(local_var_form);
...
pub async fn sign_pdf_with_cert(
	configuration: &configuration::Configuration,
	file_input: Option<std::path::PathBuf>,
	...
	if let Some(local_var_param_value) = show_signature {
		local_var_form =
			local_var_form.text("showSignature", local_var_param_value.to_string());
	}
