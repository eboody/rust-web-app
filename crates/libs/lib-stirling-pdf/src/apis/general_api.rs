...
pub trait GeneralApi: Send + Sync {
    async fn auto_split_pdf1<'file_input, 'split_type, 'split_value>(&self, file_input: Option<std::path::PathBuf>, split_type: Option<i32>, split_value: Option<&'split_value str>) -> Result<Vec<String>, Error<AutoSplitPdf1Error>>;
    async fn crop_pdf<'file_input, 'x, 'y, 'width, 'height>(&self, file_input: Option<std::path::PathBuf>, x: Option<f64>, y: Option<f64>, width: Option<f64>, height: Option<f64>) -> Result<Vec<String>, Error<CropPdfError>>;
    async fn delete_pages<'file_input, 'page_numbers>(&self, file_input: Option<std::path::PathBuf>, page_numbers: Option<&'page_numbers str>) -> Result<Vec<String>, Error<DeletePagesError>>;
    async fn merge_multiple_pages_into_one<'file_input, 'pages_per_sheet, 'add_border>(&self, file_input: Option<std::path::PathBuf>, pages_per_sheet: Option<i32>, add_border: Option<bool>) -> Result<Vec<String>, Error<MergeMultiplePagesIntoOneError>>;
    async fn merge_pdfs<'file_input, 'sort_type, 'remove_cert_sign>(&self, file_input: Option<Vec<std::path::PathBuf>>, sort_type: Option<&'sort_type str>, remove_cert_sign: Option<bool>) -> Result<Vec<String>, Error<MergePdfsError>>;
    async fn overlay_pdfs<'overlay_mode, 'file_input, 'overlay_files, 'counts, 'overlay_position>(&self, overlay_mode: &'overlay_mode str, file_input: Option<std::path::PathBuf>, overlay_files: Option<Vec<std::path::PathBuf>>, counts: Option<Vec<i32>>, overlay_position: Option<i32>) -> Result<Vec<String>, Error<OverlayPdfsError>>;
    async fn pdf_to_single_page<'file_input>(&self, file_input: Option<std::path::PathBuf>) -> Result<Vec<String>, Error<PdfToSinglePageError>>;
    async fn rearrange_pages<'file_input, 'page_numbers, 'custom_mode>(&self, file_input: Option<std::path::PathBuf>, page_numbers: Option<&'page_numbers str>, custom_mode: Option<&'custom_mode str>) -> Result<Vec<String>, Error<RearrangePagesError>>;
    async fn remove_images<'file_input>(&self, file_input: Option<std::path::PathBuf>) -> Result<Vec<String>, Error<RemoveImagesError>>;
    async fn rotate_pdf<'file_input, 'angle>(&self, file_input: Option<std::path::PathBuf>, angle: Option<i32>) -> Result<Vec<String>, Error<RotatePdfError>>;
    async fn scale_pages<'file_input, 'page_size, 'scale_factor>(&self, file_input: Option<std::path::PathBuf>, page_size: Option<&'page_size str>, scale_factor: Option<f32>) -> Result<Vec<String>, Error<ScalePagesError>>;
    async fn split_pdf<'file_input, 'horizontal_divisions, 'vertical_divisions, 'merge>(&self, file_input: Option<std::path::PathBuf>, horizontal_divisions: Option<i32>, vertical_divisions: Option<i32>, merge: Option<bool>) -> Result<Vec<String>, Error<SplitPdfError>>;
    async fn split_pdf1<'file_input, 'include_metadata, 'allow_duplicates, 'bookmark_level>(&self, file_input: Option<std::path::PathBuf>, include_metadata: Option<bool>, allow_duplicates: Option<bool>, bookmark_level: Option<i32>) -> Result<Vec<String>, Error<SplitPdf1Error>>;
    async fn split_pdf2<'file_input, 'page_numbers>(&self, file_input: Option<std::path::PathBuf>, page_numbers: Option<&'page_numbers str>) -> Result<Vec<String>, Error<SplitPdf2Error>>;
}
