...
pub trait OpenAiCompatibleEndpointsApi: Send + Sync {
    async fn v1_openai_chat_completions_post<>(&self, ) -> Result<(), Error<V1OpenaiChatCompletionsPostError>>;
    async fn v1_openai_embeddings_post<>(&self, ) -> Result<(), Error<V1OpenaiEmbeddingsPostError>>;
    async fn v1_openai_models_get<>(&self, ) -> Result<serde_json::Value, Error<V1OpenaiModelsGetError>>;
    async fn v1_openai_vector_stores_get<>(&self, ) -> Result<serde_json::Value, Error<V1OpenaiVectorStoresGetError>>;
}
...
impl OpenAiCompatibleEndpointsApi for OpenAiCompatibleEndpointsApiClient {
    ...
    async fn v1_openai_chat_completions_post<>(&self, ) -> Result<(), Error<V1OpenaiChatCompletionsPostError>> {
        ...
        let local_var_uri_str = format!("{}/v1/openai/chat/completions", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<V1OpenaiChatCompletionsPostError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn v1_openai_embeddings_post<>(&self, ) -> Result<(), Error<V1OpenaiEmbeddingsPostError>> {
        ...
        let local_var_uri_str = format!("{}/v1/openai/embeddings", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<V1OpenaiEmbeddingsPostError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn v1_openai_models_get<>(&self, ) -> Result<serde_json::Value, Error<V1OpenaiModelsGetError>> {
        ...
        let local_var_uri_str = format!("{}/v1/openai/models", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<V1OpenaiModelsGetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn v1_openai_vector_stores_get<>(&self, ) -> Result<serde_json::Value, Error<V1OpenaiVectorStoresGetError>> {
        ...
        let local_var_uri_str = format!("{}/v1/openai/vector_stores", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<V1OpenaiVectorStoresGetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
