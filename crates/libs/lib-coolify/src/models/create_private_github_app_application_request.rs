...
impl CreatePrivateGithubAppApplicationRequest {
    pub fn new(project_uuid: String, server_uuid: String, environment_name: String, github_app_uuid: String, git_repository: String, git_branch: String, ports_exposes: String, build_pack: BuildPack) -> CreatePrivateGithubAppApplicationRequest {
