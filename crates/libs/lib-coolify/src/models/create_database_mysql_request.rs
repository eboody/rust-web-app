...
pub struct CreateDatabaseMysqlRequest {
    /// UUID of the server
...
impl CreateDatabaseMysqlRequest {
    pub fn new(server_uuid: String, project_uuid: String, environment_name: String) -> CreateDatabaseMysqlRequest {
