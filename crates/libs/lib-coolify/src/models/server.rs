...
pub struct Server {
    ...
    #[serde(rename = "high_disk_usage_notification_sent", skip_serializing_if = "Option::is_none")]
    pub high_disk_usage_notification_sent: Option<bool>,
    /// The flag to indicate if the unreachable notification has been sent.
    #[serde(rename = "unreachable_notification_sent", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "log_drain_notification_sent", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "delete_unused_volumes", skip_serializing_if = "Option::is_none")]
    pub delete_unused_volumes: Option<bool>,
    /// The flag to indicate if the unused networks should be deleted.
    #[serde(rename = "delete_unused_networks", skip_serializing_if = "Option::is_none")]
