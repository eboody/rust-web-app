...
pub struct CreateDockerfileApplicationRequest {
    /// The project UUID.
...
impl CreateDockerfileApplicationRequest {
    pub fn new(project_uuid: String, server_uuid: String, environment_name: String, dockerfile: String) -> CreateDockerfileApplicationRequest {
