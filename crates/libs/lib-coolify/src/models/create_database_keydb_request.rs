...
pub struct CreateDatabaseKeydbRequest {
    /// UUID of the server
...
impl CreateDatabaseKeydbRequest {
    pub fn new(server_uuid: String, project_uuid: String, environment_name: String) -> CreateDatabaseKeydbRequest {
