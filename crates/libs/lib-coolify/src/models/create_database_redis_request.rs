...
pub struct CreateDatabaseRedisRequest {
    /// UUID of the server
...
impl CreateDatabaseRedisRequest {
    pub fn new(server_uuid: String, project_uuid: String, environment_name: String) -> CreateDatabaseRedisRequest {
