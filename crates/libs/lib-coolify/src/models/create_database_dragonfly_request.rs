...
pub struct CreateDatabaseDragonflyRequest {
    /// UUID of the server
...
impl CreateDatabaseDragonflyRequest {
    pub fn new(server_uuid: String, project_uuid: String, environment_name: String) -> CreateDatabaseDragonflyRequest {
