...
pub struct CreatePrivateDeployKeyApplicationRequest {
    /// The project UUID.
...
impl CreatePrivateDeployKeyApplicationRequest {
    pub fn new(project_uuid: String, server_uuid: String, environment_name: String, private_key_uuid: String, git_repository: String, git_branch: String, ports_exposes: String, build_pack: BuildPack) -> CreatePrivateDeployKeyApplicationRequest {
