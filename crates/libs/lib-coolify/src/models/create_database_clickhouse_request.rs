...
pub struct CreateDatabaseClickhouseRequest {
    /// UUID of the server
...
impl CreateDatabaseClickhouseRequest {
    pub fn new(server_uuid: String, project_uuid: String, environment_name: String) -> CreateDatabaseClickhouseRequest {
