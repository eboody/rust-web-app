...
pub struct UpdateEnvByApplicationUuidRequest {
...
impl UpdateEnvByApplicationUuidRequest {
    pub fn new(key: String, value: String) -> UpdateEnvByApplicationUuidRequest {
