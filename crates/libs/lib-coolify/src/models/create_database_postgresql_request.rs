...
pub struct CreateDatabasePostgresqlRequest {
    /// UUID of the server
...
impl CreateDatabasePostgresqlRequest {
    pub fn new(server_uuid: String, project_uuid: String, environment_name: String) -> CreateDatabasePostgresqlRequest {
