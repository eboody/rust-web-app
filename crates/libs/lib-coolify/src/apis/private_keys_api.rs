...
pub trait PrivateKeysApi: Send + Sync {
	async fn create_private_key<'create_private_key_request>(
		&self,
		create_private_key_request: models::CreatePrivateKeyRequest,
	) -> Result<
		models::UpdateApplicationByUuid200Response,
		Error<CreatePrivateKeyError>,
	>;
	async fn delete_private_key_by_uuid<'uuid>(
		&self,
		uuid: &'uuid str,
	) -> Result<
		models::DeletePrivateKeyByUuid200Response,
		Error<DeletePrivateKeyByUuidError>,
	>;
	async fn get_private_key_by_uuid<'uuid>(
		&self,
		uuid: &'uuid str,
	) -> Result<models::PrivateKey, Error<GetPrivateKeyByUuidError>>;
	async fn list_private_keys(
		&self,
	) -> Result<Vec<models::PrivateKey>, Error<ListPrivateKeysError>>;
	async fn update_private_key<'update_private_key_request>(
		&self,
		update_private_key_request: models::UpdatePrivateKeyRequest,
	) -> Result<
		models::UpdateApplicationByUuid200Response,
		Error<UpdatePrivateKeyError>,
	>;
}
...
impl PrivateKeysApi for PrivateKeysApiClient {
	...
	> {
		...
		let local_var_uri_str =
			format!("{}/security/keys", local_var_configuration.base_path);
		...
		local_var_req_builder =
			local_var_req_builder.json(&create_private_key_request);
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<CreatePrivateKeyError> =
	...
	> {
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<DeletePrivateKeyByUuidError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn get_private_key_by_uuid<'uuid>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<GetPrivateKeyByUuidError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn list_private_keys(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<ListPrivateKeysError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	> {
		...
		local_var_req_builder =
			local_var_req_builder.json(&update_private_key_request);
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<UpdatePrivateKeyError> =
				json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
