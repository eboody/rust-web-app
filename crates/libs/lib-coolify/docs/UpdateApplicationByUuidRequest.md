...
------------ | ------------- | ------------- | -------------
**project_uuid** | Option<**String**> | The project UUID. | [optional]
**server_uuid** | Option<**String**> | The server UUID. | [optional]
**environment_name** | Option<**String**> | The environment name. | [optional]
**github_app_uuid** | Option<**String**> | The Github App UUID. | [optional]
**git_repository** | Option<**String**> | The git repository URL. | [optional]
**git_branch** | Option<**String**> | The git branch. | [optional]
