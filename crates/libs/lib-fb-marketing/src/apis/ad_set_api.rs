...
pub trait AdSetApi: Send + Sync {
	async fn create_ad_set<'ad_account_id, 'properties>(
		&self,
		ad_account_id: &'ad_account_id str,
		properties: models::AdSet,
	) -> Result<models::AdSetResponse, Error<CreateAdSetError>>;
	async fn delete_ad_set<'ad_set_id>(
		&self,
		ad_set_id: &'ad_set_id str,
	) -> Result<models::AdSetResponse, Error<DeleteAdSetError>>;
	async fn get_ad_set<'ad_set_id, 'date_preset, 'time_range, 'fields>(
		&self,
		ad_set_id: &'ad_set_id str,
		date_preset: Option<&'date_preset str>,
		time_range: Option<models::TimeRange>,
		fields: Option<Vec<String>>,
	) -> Result<models::AdSet, Error<GetAdSetError>>;
	async fn get_ad_sets<'ad_account_id, 'date_preset, 'time_range, 'fields>(
		&self,
		ad_account_id: &'ad_account_id str,
		date_preset: Option<&'date_preset str>,
		time_range: Option<models::TimeRange>,
		fields: Option<Vec<String>>,
	) -> Result<models::AdSetList, Error<GetAdSetsError>>;
	async fn update_ad_set<'ad_set_id, 'properties>(
		&self,
		ad_set_id: &'ad_set_id str,
		properties: models::AdSetUpdate,
	) -> Result<models::AdSetResponse, Error<UpdateAdSetError>>;
}
...
impl AdSetApi for AdSetApiClient {
	...
	async fn create_ad_set<'ad_account_id, 'properties>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<CreateAdSetError> =
	...
	async fn delete_ad_set<'ad_set_id>(
		...
		let local_var_uri_str = format!(
			"{}/{ad_set_id}",
			local_var_configuration.base_path,
			ad_set_id = crate::apis::urlencode(ad_set_id)
		);
		let mut local_var_req_builder = local_var_client
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<DeleteAdSetError> =
				serde_json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn get_ad_set<'ad_set_id, 'date_preset, 'time_range, 'fields>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<GetAdSetError> =
				serde_json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn get_ad_sets<'ad_account_id, 'date_preset, 'time_range, 'fields>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<GetAdSetsError> =
				serde_json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn update_ad_set<'ad_set_id, 'properties>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<UpdateAdSetError> =
				serde_json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
