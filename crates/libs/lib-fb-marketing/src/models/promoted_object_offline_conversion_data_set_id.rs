...
/// PromotedObjectOfflineConversionDataSetId : The ID of the offline dataset
/// The ID of the offline dataset
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PromotedObjectOfflineConversionDataSetId {
	String(String),
	Integer(i32),
}

impl Default for PromotedObjectOfflineConversionDataSetId {
	fn default() -> Self {
