...
/// AdSetUpdate : Ad set update properties
...
pub struct AdSetUpdate {
    ...
    #[serde(rename = "contextual_bundling_spec", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "daily_min_spend_target", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "existing_customer_budget_percentage", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "is_dynamic_creative", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "lifetime_min_spend_target", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "multi_optimization_goal_weight", skip_serializing_if = "Option::is_none")]
    ...
    /// What the ad set is optimizing for.
    #[serde(rename = "optimization_sub_event", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "rb_prediction_id", skip_serializing_if = "Option::is_none")]
    pub rb_prediction_id: Option<Box<models::AdSetUpdateRbPredictionId>>,
    ...
    #[serde(rename = "time_based_ad_rotation_id_blocks", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "time_based_ad_rotation_intervals", skip_serializing_if = "Option::is_none")]
