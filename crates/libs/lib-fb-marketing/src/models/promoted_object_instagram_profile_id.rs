...
/// PromotedObjectInstagramProfileId : The ID of the instagram profile id
/// The ID of the instagram profile id
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PromotedObjectInstagramProfileId {
	String(String),
	Integer(i32),
}

impl Default for PromotedObjectInstagramProfileId {
	fn default() -> Self {
