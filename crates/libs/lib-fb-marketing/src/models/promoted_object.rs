...
pub struct PromotedObject {
	...
	#[serde(
		rename = "offline_conversion_data_set_id",
		skip_serializing_if = "Option::is_none"
	)]
	pub offline_conversion_data_set_id:
		Option<Box<models::PromotedObjectOfflineConversionDataSetId>>,
	#[serde(
		rename = "fundraiser_campaign_id",
		skip_serializing_if = "Option::is_none"
	)]
	pub fundraiser_campaign_id:
		Option<Box<models::PromotedObjectFundraiserCampaignId>>,
	/// The event from an App Event of a mobile app, not in the standard event list.
