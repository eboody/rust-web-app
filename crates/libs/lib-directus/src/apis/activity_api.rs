...
pub trait ActivityApi: Send + Sync {
    async fn get_activities<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>) -> Result<models::GetActivities200Response, Error<GetActivitiesError>>;
    async fn get_activity<'id, 'fields, 'meta>(&self, id: i32, fields: Option<Vec<String>>, meta: Option<&'meta str>) -> Result<models::GetActivity200Response, Error<GetActivityError>>;
}
...
impl ActivityApi for ActivityApiClient {
    ...
    async fn get_activity<'id, 'fields, 'meta>(&self, id: i32, fields: Option<Vec<String>>, meta: Option<&'meta str>) -> Result<models::GetActivity200Response, Error<GetActivityError>> {
        ...
        let local_var_uri_str = format!("{}/activity/{id}", local_var_configuration.base_path, id=id);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
