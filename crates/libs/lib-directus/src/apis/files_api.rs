...
pub trait FilesApi: Send + Sync {
    async fn create_file<'create_file_request>(&self, create_file_request: Option<models::CreateFileRequest>) -> Result<models::CreateFile200Response, Error<CreateFileError>>;
    async fn delete_file<'id>(&self, id: &'id str) -> Result<(), Error<DeleteFileError>>;
    async fn delete_files<>(&self, ) -> Result<(), Error<DeleteFilesError>>;
    async fn get_file<'id, 'fields, 'meta>(&self, id: &'id str, fields: Option<Vec<String>>, meta: Option<&'meta str>) -> Result<models::CreateFile200Response, Error<GetFileError>>;
    async fn get_files<'fields, 'limit, 'offset, 'sort, 'filter, 'search, 'meta>(&self, fields: Option<Vec<String>>, limit: Option<i32>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, meta: Option<&'meta str>) -> Result<models::GetFiles200Response, Error<GetFilesError>>;
    async fn update_file<'id, 'file, 'fields, 'meta, 'title, 'filename_download, 'description, 'folder, 'tags>(&self, id: &'id str, file: Option<models::serde_json::Value>, fields: Option<Vec<String>>, meta: Option<&'meta str>, title: Option<&'title str>, filename_download: Option<&'filename_download str>, description: Option<&'description str>, folder: Option<models::models::UpdateFileRequestFolder>, tags: Option<Vec<String>>) -> Result<models::CreateFile200Response, Error<UpdateFileError>>;
    async fn update_files<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'update_files_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, update_files_request: Option<models::UpdateFilesRequest>) -> Result<models::GetFiles200Response, Error<UpdateFilesError>>;
}
...
impl FilesApi for FilesApiClient {
    ...
    async fn delete_file<'id>(&self, id: &'id str) -> Result<(), Error<DeleteFileError>> {
        ...
        let local_var_uri_str = format!("{}/files/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
    ...
    async fn delete_files<>(&self, ) -> Result<(), Error<DeleteFilesError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteFilesError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_file<'id, 'file, 'fields, 'meta, 'title, 'filename_download, 'description, 'folder, 'tags>(&self, id: &'id str, file: Option<models::serde_json::Value>, fields: Option<Vec<String>>, meta: Option<&'meta str>, title: Option<&'title str>, filename_download: Option<&'filename_download str>, description: Option<&'description str>, folder: Option<models::models::UpdateFileRequestFolder>, tags: Option<Vec<String>>) -> Result<models::CreateFile200Response, Error<UpdateFileError>> {
        ...
        if let Some(local_var_param_value) = filename_download {
            local_var_form = local_var_form.text("filename_download", local_var_param_value.to_string());
        }
        ...
        if let Some(local_var_param_value) = folder {
            local_var_form = local_var_form.text("folder", local_var_param_value.to_string());
        }
        ...
        match file {
            Some(local_var_param_value) => { local_var_form = local_var_form.text("file", local_var_param_value.to_string()); },
            None => { local_var_form = local_var_form.text("file", ""); },
        }
    ...
    async fn update_files<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'update_files_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, update_files_request: Option<models::UpdateFilesRequest>) -> Result<models::GetFiles200Response, Error<UpdateFilesError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateFilesError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
