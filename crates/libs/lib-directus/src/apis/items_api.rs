...
pub trait ItemsApi: Send + Sync {
    ...
    async fn create_items_articles_translations<'meta, 'create_items_articles_translations_request>(&self, meta: Option<&'meta str>, create_items_articles_translations_request: Option<models::CreateItemsArticlesTranslationsRequest>) -> Result<models::CreateItemsArticlesTranslations200Response, Error<CreateItemsArticlesTranslationsError>>;
    async fn create_items_ebooks<'meta, 'create_items_ebooks_request>(&self, meta: Option<&'meta str>, create_items_ebooks_request: Option<models::CreateItemsEbooksRequest>) -> Result<models::CreateItemsEbooks200Response, Error<CreateItemsEbooksError>>;
    ...
    async fn create_items_ebooks_translations<'meta, 'create_items_ebooks_translations_request>(&self, meta: Option<&'meta str>, create_items_ebooks_translations_request: Option<models::CreateItemsEbooksTranslationsRequest>) -> Result<models::CreateItemsEbooksTranslations200Response, Error<CreateItemsEbooksTranslationsError>>;
    ...
    async fn create_items_tags_translations<'meta, 'create_items_tags_translations_request>(&self, meta: Option<&'meta str>, create_items_tags_translations_request: Option<models::CreateItemsTagsTranslationsRequest>) -> Result<models::CreateItemsTagsTranslations200Response, Error<CreateItemsTagsTranslationsError>>;
    ...
    async fn delete_items_articles_translations<>(&self, ) -> Result<(), Error<DeleteItemsArticlesTranslationsError>>;
    async fn delete_items_ebooks<>(&self, ) -> Result<(), Error<DeleteItemsEbooksError>>;
    ...
    async fn delete_items_ebooks_translations<>(&self, ) -> Result<(), Error<DeleteItemsEbooksTranslationsError>>;
    ...
    async fn delete_items_tags_translations<>(&self, ) -> Result<(), Error<DeleteItemsTagsTranslationsError>>;
    ...
    async fn delete_single_items_articles_translations<'id>(&self, id: models::ReadSingleItemsLanguagesIdParameter) -> Result<(), Error<DeleteSingleItemsArticlesTranslationsError>>;
    async fn delete_single_items_ebooks<'id>(&self, id: models::ReadSingleItemsLanguagesIdParameter) -> Result<(), Error<DeleteSingleItemsEbooksError>>;
    ...
    async fn delete_single_items_ebooks_translations<'id>(&self, id: models::ReadSingleItemsLanguagesIdParameter) -> Result<(), Error<DeleteSingleItemsEbooksTranslationsError>>;
    ...
    async fn delete_single_items_tags_translations<'id>(&self, id: models::ReadSingleItemsLanguagesIdParameter) -> Result<(), Error<DeleteSingleItemsTagsTranslationsError>>;
    ...
    async fn read_items_articles_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>) -> Result<models::ReadItemsArticlesTranslations200Response, Error<ReadItemsArticlesTranslationsError>>;
    async fn read_items_ebooks<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>) -> Result<models::ReadItemsEbooks200Response, Error<ReadItemsEbooksError>>;
    ...
    async fn read_items_ebooks_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>) -> Result<models::ReadItemsEbooksTranslations200Response, Error<ReadItemsEbooksTranslationsError>>;
    ...
    async fn read_items_tags_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>) -> Result<models::ReadItemsTagsTranslations200Response, Error<ReadItemsTagsTranslationsError>>;
    ...
    async fn read_single_items_articles_translations<'id, 'fields, 'meta, 'version>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, version: Option<&'version str>) -> Result<models::ReadSingleItemsArticlesTranslations200Response, Error<ReadSingleItemsArticlesTranslationsError>>;
    async fn read_single_items_ebooks<'id, 'fields, 'meta, 'version>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, version: Option<&'version str>) -> Result<models::ReadSingleItemsEbooks200Response, Error<ReadSingleItemsEbooksError>>;
    ...
    async fn read_single_items_ebooks_translations<'id, 'fields, 'meta, 'version>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, version: Option<&'version str>) -> Result<models::ReadSingleItemsEbooksTranslations200Response, Error<ReadSingleItemsEbooksTranslationsError>>;
    ...
    async fn read_single_items_tags_translations<'id, 'fields, 'meta, 'version>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, version: Option<&'version str>) -> Result<models::ReadSingleItemsTagsTranslations200Response, Error<ReadSingleItemsTagsTranslationsError>>;
    ...
    async fn update_items_articles_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'create_items_articles_translations_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, create_items_articles_translations_request: Option<models::CreateItemsArticlesTranslationsRequest>) -> Result<models::UpdateItemsArticlesTranslations200Response, Error<UpdateItemsArticlesTranslationsError>>;
    async fn update_items_ebooks<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'create_items_ebooks_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, create_items_ebooks_request: Option<models::CreateItemsEbooksRequest>) -> Result<models::UpdateItemsEbooks200Response, Error<UpdateItemsEbooksError>>;
    ...
    async fn update_items_ebooks_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'create_items_ebooks_translations_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, create_items_ebooks_translations_request: Option<models::CreateItemsEbooksTranslationsRequest>) -> Result<models::UpdateItemsEbooksTranslations200Response, Error<UpdateItemsEbooksTranslationsError>>;
    ...
    async fn update_items_tags_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'create_items_tags_translations_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, create_items_tags_translations_request: Option<models::CreateItemsTagsTranslationsRequest>) -> Result<models::UpdateItemsTagsTranslations200Response, Error<UpdateItemsTagsTranslationsError>>;
    ...
    async fn update_single_items_articles_translations<'id, 'fields, 'meta, 'items_articles_translations>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, items_articles_translations: Option<models::ItemsArticlesTranslations>) -> Result<models::ReadSingleItemsArticlesTranslations200Response, Error<UpdateSingleItemsArticlesTranslationsError>>;
    async fn update_single_items_ebooks<'id, 'fields, 'meta, 'items_ebooks>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, items_ebooks: Option<models::ItemsEbooks>) -> Result<models::ReadSingleItemsEbooks200Response, Error<UpdateSingleItemsEbooksError>>;
    ...
    async fn update_single_items_ebooks_translations<'id, 'fields, 'meta, 'items_ebooks_translations>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, items_ebooks_translations: Option<models::ItemsEbooksTranslations>) -> Result<models::ReadSingleItemsEbooksTranslations200Response, Error<UpdateSingleItemsEbooksTranslationsError>>;
    ...
    async fn update_single_items_tags_translations<'id, 'fields, 'meta, 'items_tags_translations>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, items_tags_translations: Option<models::ItemsTagsTranslations>) -> Result<models::ReadSingleItemsTagsTranslations200Response, Error<UpdateSingleItemsTagsTranslationsError>>;
}
...
impl ItemsApi for ItemsApiClient {
    ...
    async fn create_items_articles_translations<'meta, 'create_items_articles_translations_request>(&self, meta: Option<&'meta str>, create_items_articles_translations_request: Option<models::CreateItemsArticlesTranslationsRequest>) -> Result<models::CreateItemsArticlesTranslations200Response, Error<CreateItemsArticlesTranslationsError>> {
        ...
        let local_var_uri_str = format!("{}/items/articles_translations", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        local_var_req_builder = local_var_req_builder.json(&create_items_articles_translations_request);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateItemsArticlesTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn create_items_ebooks<'meta, 'create_items_ebooks_request>(&self, meta: Option<&'meta str>, create_items_ebooks_request: Option<models::CreateItemsEbooksRequest>) -> Result<models::CreateItemsEbooks200Response, Error<CreateItemsEbooksError>> {
        ...
        let local_var_uri_str = format!("{}/items/ebooks", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        local_var_req_builder = local_var_req_builder.json(&create_items_ebooks_request);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateItemsEbooksError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn create_items_ebooks_translations<'meta, 'create_items_ebooks_translations_request>(&self, meta: Option<&'meta str>, create_items_ebooks_translations_request: Option<models::CreateItemsEbooksTranslationsRequest>) -> Result<models::CreateItemsEbooksTranslations200Response, Error<CreateItemsEbooksTranslationsError>> {
        ...
        let local_var_uri_str = format!("{}/items/ebooks_translations", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        local_var_req_builder = local_var_req_builder.json(&create_items_ebooks_translations_request);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateItemsEbooksTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn create_items_tags_translations<'meta, 'create_items_tags_translations_request>(&self, meta: Option<&'meta str>, create_items_tags_translations_request: Option<models::CreateItemsTagsTranslationsRequest>) -> Result<models::CreateItemsTagsTranslations200Response, Error<CreateItemsTagsTranslationsError>> {
        ...
        let local_var_uri_str = format!("{}/items/tags_translations", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        local_var_req_builder = local_var_req_builder.json(&create_items_tags_translations_request);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateItemsTagsTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_items_articles_translations<>(&self, ) -> Result<(), Error<DeleteItemsArticlesTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteItemsArticlesTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_items_ebooks<>(&self, ) -> Result<(), Error<DeleteItemsEbooksError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteItemsEbooksError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_items_ebooks_translations<>(&self, ) -> Result<(), Error<DeleteItemsEbooksTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteItemsEbooksTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_items_tags_translations<>(&self, ) -> Result<(), Error<DeleteItemsTagsTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteItemsTagsTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_single_items_articles_translations<'id>(&self, id: models::ReadSingleItemsLanguagesIdParameter) -> Result<(), Error<DeleteSingleItemsArticlesTranslationsError>> {
        ...
        let local_var_uri_str = format!("{}/items/articles_translations/{id}", local_var_configuration.base_path, id=id.to_string());
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteSingleItemsArticlesTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_single_items_ebooks<'id>(&self, id: models::ReadSingleItemsLanguagesIdParameter) -> Result<(), Error<DeleteSingleItemsEbooksError>> {
        ...
        let local_var_uri_str = format!("{}/items/ebooks/{id}", local_var_configuration.base_path, id=id.to_string());
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteSingleItemsEbooksError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_single_items_ebooks_translations<'id>(&self, id: models::ReadSingleItemsLanguagesIdParameter) -> Result<(), Error<DeleteSingleItemsEbooksTranslationsError>> {
        ...
        let local_var_uri_str = format!("{}/items/ebooks_translations/{id}", local_var_configuration.base_path, id=id.to_string());
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteSingleItemsEbooksTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_single_items_tags_translations<'id>(&self, id: models::ReadSingleItemsLanguagesIdParameter) -> Result<(), Error<DeleteSingleItemsTagsTranslationsError>> {
        ...
        let local_var_uri_str = format!("{}/items/tags_translations/{id}", local_var_configuration.base_path, id=id.to_string());
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteSingleItemsTagsTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn read_items_articles_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>) -> Result<models::ReadItemsArticlesTranslations200Response, Error<ReadItemsArticlesTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadItemsArticlesTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn read_items_ebooks<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>) -> Result<models::ReadItemsEbooks200Response, Error<ReadItemsEbooksError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadItemsEbooksError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn read_items_ebooks_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>) -> Result<models::ReadItemsEbooksTranslations200Response, Error<ReadItemsEbooksTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadItemsEbooksTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn read_items_tags_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>) -> Result<models::ReadItemsTagsTranslations200Response, Error<ReadItemsTagsTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadItemsTagsTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn read_single_items_articles_translations<'id, 'fields, 'meta, 'version>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, version: Option<&'version str>) -> Result<models::ReadSingleItemsArticlesTranslations200Response, Error<ReadSingleItemsArticlesTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadSingleItemsArticlesTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn read_single_items_ebooks<'id, 'fields, 'meta, 'version>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, version: Option<&'version str>) -> Result<models::ReadSingleItemsEbooks200Response, Error<ReadSingleItemsEbooksError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadSingleItemsEbooksError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn read_single_items_ebooks_translations<'id, 'fields, 'meta, 'version>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, version: Option<&'version str>) -> Result<models::ReadSingleItemsEbooksTranslations200Response, Error<ReadSingleItemsEbooksTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadSingleItemsEbooksTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn read_single_items_tags_translations<'id, 'fields, 'meta, 'version>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, version: Option<&'version str>) -> Result<models::ReadSingleItemsTagsTranslations200Response, Error<ReadSingleItemsTagsTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadSingleItemsTagsTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_items_articles_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'create_items_articles_translations_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, create_items_articles_translations_request: Option<models::CreateItemsArticlesTranslationsRequest>) -> Result<models::UpdateItemsArticlesTranslations200Response, Error<UpdateItemsArticlesTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateItemsArticlesTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_items_ebooks<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'create_items_ebooks_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, create_items_ebooks_request: Option<models::CreateItemsEbooksRequest>) -> Result<models::UpdateItemsEbooks200Response, Error<UpdateItemsEbooksError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateItemsEbooksError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_items_ebooks_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'create_items_ebooks_translations_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, create_items_ebooks_translations_request: Option<models::CreateItemsEbooksTranslationsRequest>) -> Result<models::UpdateItemsEbooksTranslations200Response, Error<UpdateItemsEbooksTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateItemsEbooksTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_items_tags_translations<'fields, 'limit, 'meta, 'offset, 'sort, 'filter, 'search, 'create_items_tags_translations_request>(&self, fields: Option<Vec<String>>, limit: Option<i32>, meta: Option<&'meta str>, offset: Option<i32>, sort: Option<Vec<String>>, filter: Option<models::serde_json::Value>, search: Option<&'search str>, create_items_tags_translations_request: Option<models::CreateItemsTagsTranslationsRequest>) -> Result<models::UpdateItemsTagsTranslations200Response, Error<UpdateItemsTagsTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateItemsTagsTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_single_items_articles_translations<'id, 'fields, 'meta, 'items_articles_translations>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, items_articles_translations: Option<models::ItemsArticlesTranslations>) -> Result<models::ReadSingleItemsArticlesTranslations200Response, Error<UpdateSingleItemsArticlesTranslationsError>> {
        ...
        local_var_req_builder = local_var_req_builder.json(&items_articles_translations);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateSingleItemsArticlesTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_single_items_ebooks<'id, 'fields, 'meta, 'items_ebooks>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, items_ebooks: Option<models::ItemsEbooks>) -> Result<models::ReadSingleItemsEbooks200Response, Error<UpdateSingleItemsEbooksError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateSingleItemsEbooksError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_single_items_ebooks_translations<'id, 'fields, 'meta, 'items_ebooks_translations>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, items_ebooks_translations: Option<models::ItemsEbooksTranslations>) -> Result<models::ReadSingleItemsEbooksTranslations200Response, Error<UpdateSingleItemsEbooksTranslationsError>> {
        ...
        local_var_req_builder = local_var_req_builder.json(&items_ebooks_translations);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateSingleItemsEbooksTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_single_items_tags_translations<'id, 'fields, 'meta, 'items_tags_translations>(&self, id: models::ReadSingleItemsLanguagesIdParameter, fields: Option<Vec<String>>, meta: Option<&'meta str>, items_tags_translations: Option<models::ItemsTagsTranslations>) -> Result<models::ReadSingleItemsTagsTranslations200Response, Error<UpdateSingleItemsTagsTranslationsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateSingleItemsTagsTranslationsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
