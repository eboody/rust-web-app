...
pub trait FlowsApi: Send + Sync {
	async fn create_flow<'fields, 'meta, 'flows>(
		&self,
		fields: Option<Vec<String>>,
		meta: Option<&'meta str>,
		flows: Option<models::Flows>,
	) -> Result<models::CreateFlow200Response, Error<CreateFlowError>>;
	async fn delete_flow<'id>(
		&self,
		id: &'id str,
	) -> Result<(), Error<DeleteFlowError>>;
	async fn delete_flows(&self) -> Result<(), Error<DeleteFlowsError>>;
	async fn get_flow<'id>(
		&self,
		id: &'id str,
	) -> Result<models::CreateFlow200Response, Error<GetFlowError>>;
	async fn get_flows(
		&self,
	) -> Result<models::GetFlows200Response, Error<GetFlowsError>>;
	async fn update_flow<'id, 'fields, 'meta, 'flows>(
		&self,
		id: &'id str,
		fields: Option<Vec<String>>,
		meta: Option<&'meta str>,
		flows: Option<models::Flows>,
	) -> Result<models::CreateFlow200Response, Error<UpdateFlowError>>;
	...
	>(
		...
		update_flows_request: Option<models::UpdateFlowsRequest>,
	) -> Result<models::GetFlows200Response, Error<UpdateFlowsError>>;
}
...
impl FlowsApi for FlowsApiClient {
	...
	async fn create_flow<'fields, 'meta, 'flows>(
		...
		let local_var_uri_str =
			format!("{}/flows", local_var_configuration.base_path);
	...
	async fn delete_flows(&self) -> Result<(), Error<DeleteFlowsError>> {
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<DeleteFlowsError> =
				serde_json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn get_flow<'id>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<GetFlowError> =
				serde_json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	async fn get_flows(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<GetFlowsError> =
				serde_json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
	...
	>(
		...
		if !local_var_status.is_client_error() && !local_var_status.is_server_error()
		{
			...
			let local_var_entity: Option<UpdateFlowsError> =
				serde_json::from_str(&local_var_content).ok();
			let local_var_error = ResponseContent {
				status: local_var_status,
				content: local_var_content,
