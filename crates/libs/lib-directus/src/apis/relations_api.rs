...
pub trait RelationsApi: Send + Sync {
	async fn create_relation<'fields, 'meta, 'create_relation_request>(
		&self,
		fields: Option<Vec<String>>,
		meta: Option<&'meta str>,
		create_relation_request: Option<models::CreateRelationRequest>,
	) -> Result<models::CreateRelation200Response, Error<CreateRelationError>>;
	async fn delete_relation<'id>(
		&self,
		id: i32,
	) -> Result<(), Error<DeleteRelationError>>;
	async fn get_relation<'id, 'fields, 'meta>(
		&self,
		id: i32,
		fields: Option<Vec<String>>,
		meta: Option<&'meta str>,
	) -> Result<models::CreateRelation200Response, Error<GetRelationError>>;
	...
	>(
		...
		page: Option<i32>,
	) -> Result<models::GetRelations200Response, Error<GetRelationsError>>;
	async fn update_relation<'id, 'fields, 'meta, 'update_relation_request>(
		&self,
		id: i32,
		fields: Option<Vec<String>>,
		meta: Option<&'meta str>,
		update_relation_request: Option<models::UpdateRelationRequest>,
	) -> Result<models::CreateRelation200Response, Error<UpdateRelationError>>;
}
...
impl RelationsApi for RelationsApiClient {
	...
	async fn create_relation<'fields, 'meta, 'create_relation_request>(
		...
		let local_var_uri_str =
			format!("{}/relations", local_var_configuration.base_path);
