...
pub trait PresetsApi: Send + Sync {
	async fn create_preset<'fields, 'meta, 'create_preset_request>(
		&self,
		fields: Option<Vec<String>>,
		meta: Option<&'meta str>,
		create_preset_request: Option<models::CreatePresetRequest>,
	) -> Result<models::CreatePreset200Response, Error<CreatePresetError>>;
	async fn delete_preset<'id>(
		&self,
		id: i32,
	) -> Result<(), Error<DeletePresetError>>;
	async fn delete_presets(&self) -> Result<(), Error<DeletePresetsError>>;
	async fn get_preset<'id, 'fields, 'meta>(
		&self,
		id: i32,
		fields: Option<Vec<String>>,
		meta: Option<&'meta str>,
	) -> Result<models::CreatePreset200Response, Error<GetPresetError>>;
	...
	async fn update_preset<'id, 'fields, 'meta, 'update_preset_request>(
		&self,
		id: i32,
		fields: Option<Vec<String>>,
		meta: Option<&'meta str>,
		update_preset_request: Option<models::UpdatePresetRequest>,
	) -> Result<models::CreatePreset200Response, Error<UpdatePresetError>>;
...
impl PresetsApi for PresetsApiClient {
	...
	async fn create_preset<'fields, 'meta, 'create_preset_request>(
		...
		let local_var_uri_str =
			format!("{}/presets", local_var_configuration.base_path);
