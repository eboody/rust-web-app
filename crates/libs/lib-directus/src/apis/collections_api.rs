...
pub trait CollectionsApi: Send + Sync {
	async fn create_collection<'meta, 'create_collection_request>(
		&self,
		meta: Option<&'meta str>,
		create_collection_request: Option<models::CreateCollectionRequest>,
	) -> Result<models::CreateCollection200Response, Error<CreateCollectionError>>;
	async fn delete_collection<'id>(
		&self,
		id: &'id str,
	) -> Result<(), Error<DeleteCollectionError>>;
	async fn get_collection<'id, 'meta>(
		&self,
		id: &'id str,
		meta: Option<&'meta str>,
	) -> Result<models::CreateCollection200Response, Error<GetCollectionError>>;
	async fn get_collections<'offset, 'meta>(
		&self,
		offset: Option<i32>,
		meta: Option<&'meta str>,
	) -> Result<models::GetCollections200Response, Error<GetCollectionsError>>;
	async fn update_collection<'id, 'meta, 'update_collection_request>(
		&self,
		id: &'id str,
		meta: Option<&'meta str>,
		update_collection_request: Option<models::UpdateCollectionRequest>,
	) -> Result<models::CreateCollection200Response, Error<UpdateCollectionError>>;
}
...
impl CollectionsApi for CollectionsApiClient {
	...
	async fn create_collection<'meta, 'create_collection_request>(
		...
		let local_var_uri_str =
			format!("{}/collections", local_var_configuration.base_path);
