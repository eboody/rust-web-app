...
pub struct Fields {
    ...
    #[serde(rename = "interface", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "display", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub display: Option<Option<String>>,
    #[serde(rename = "display_options", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub group: Option<Option<Box<models::FieldsGroup>>>,
    #[serde(rename = "validation", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub validation: Option<Option<serde_json::Value>>,
    #[serde(rename = "validation_message", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
