...
pub struct Flows {
    ...
    pub user_created: Option<Box<models::FlowsUserCreated>>,
    #[serde(rename = "operations", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub operations: Option<Option<Vec<models::FlowsOperationsInner>>>,
}
