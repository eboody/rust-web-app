...
pub struct CreateCollectionRequest {
    ...
    #[serde(rename = "archive_app_filter", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl CreateCollectionRequest {
    pub fn new(collection: String, fields: Vec<serde_json::Value>) -> CreateCollectionRequest {
