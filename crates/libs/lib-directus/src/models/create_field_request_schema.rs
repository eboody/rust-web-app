...
pub struct CreateFieldRequestSchema {
    ...
    #[serde(rename = "foreign_key_column", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub foreign_key_column: Option<Option<String>>,
    /// Related table from the foreign key constraint.
    #[serde(rename = "foreign_key_table", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "foreign_key_schema", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
