...
pub struct Relations {
    ...
    #[serde(rename = "one_field", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub one_field: Option<Option<String>>,
    #[serde(rename = "one_collection_field", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub one_collection_field: Option<Option<String>>,
    #[serde(rename = "one_allowed_collections", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "junction_field", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "one_deselect_action", skip_serializing_if = "Option::is_none")]
