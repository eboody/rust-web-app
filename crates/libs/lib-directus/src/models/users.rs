...
pub struct Users {
    ...
    pub avatar: Option<Option<Box<models::UsersAvatar>>>,
    /// The user's language used in Directus.
    #[serde(rename = "language", skip_serializing_if = "Option::is_none")]
    pub language: Option<String>,
    /// The 2FA secret string that's used to generate one time passwords.
    #[serde(rename = "tfa_secret", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tfa_secret: Option<Option<String>>,
    /// Status of the user.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Status>,
    #[serde(rename = "role", skip_serializing_if = "Option::is_none")]
    pub role: Option<Box<models::UsersRole>>,
    ...
    #[serde(rename = "last_access", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "external_identifier", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "email_notifications", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub email_notifications: Option<Option<bool>>,
    #[serde(rename = "appearance", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub appearance: Option<Option<String>>,
    #[serde(rename = "theme_dark", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub theme_dark: Option<Option<String>>,
    #[serde(rename = "theme_light", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
