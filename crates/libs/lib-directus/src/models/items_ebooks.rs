...
pub struct ItemsEbooks {
    ...
    #[serde(rename = "date_published", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub translations: Option<Option<Vec<models::ItemsEbooksTranslationsInner>>>,
    #[serde(rename = "authors", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub authors: Option<Option<Vec<models::ItemsEbooksAuthorsInner>>>,
    #[serde(rename = "tags", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tags: Option<Option<Vec<models::ItemsEbooksTagsInner>>>,
}
