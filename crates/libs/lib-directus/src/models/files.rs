...
pub struct Files {
    ...
    pub folder: Option<Option<Box<models::UpdateFileRequestFolder>>>,
    #[serde(rename = "uploaded_by", skip_serializing_if = "Option::is_none")]
    pub uploaded_by: Option<Box<models::FilesUploadedBy>>,
    ...
    pub modified_by: Option<Option<Box<models::FilesModifiedBy>>>,
    ...
    #[serde(rename = "focal_point_x", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub focal_point_x: Option<Option<i32>>,
    #[serde(rename = "focal_point_y", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub focal_point_y: Option<Option<i32>>,
    #[serde(rename = "tus_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tus_id: Option<Option<String>>,
    #[serde(rename = "tus_data", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
