...
pub struct Presets {
    ...
    #[serde(rename = "layout_query", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub layout_query: Option<Option<serde_json::Value>>,
    /// Options of the views. The properties in here are controlled by the layout.
    #[serde(rename = "layout_options", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub layout_options: Option<Option<serde_json::Value>>,
    #[serde(rename = "refresh_interval", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
